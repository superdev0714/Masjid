...
- (IBAction)leftNavigationBar:(id)sender {
}

//- (UIEdgeInsets)alignmentRectInsets {
//    return UIEdgeInsetsMake(0, -40, 0, 15.0f); // here you can play with values to align your button properly
//}
...
- (void)viewDidLoad
{
    ...
    //UIImage *buttonImage = [UIImage imageNamed:@"Dashboard-3.png"];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setImage:buttonImage forState:UIControlStateNormal];
    
    //button.frame = CGRectMake(0, 0, 67, 32);
//    button.backgroundColor = [UIColor redColor];
    //button.frame = CGRectMake(0, 0,52,28);
