...
@interface TimeTableView () <UNUserNotificationCenterDelegate>
{
    ...
    if (timeTable) {
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                //currentView.fajarLabel.textColor  = [UIColor purpleColor];
                currentView.fajarLabel.text = currentView.fajarLabel.text;
                
                
                /*if (pageNumber == 0) {
                    currentView.fajarLabel.backgroundColor = [UIColor orangeColor];
                }
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.fajarTitleLabel.textColor = [UIColor greenColor];
                currentView.fajarJLabel.text = currentView.fajarJLabel.text;
                /*if (pageNumber == 0) {
                    currentView.fajarJLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.fajarJLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.fajarTitleLabel.textColor = [UIColor greenColor];
                currentView.sunriselabel.text = currentView.sunriselabel.text;
                /*if (pageNumber == 0) {
                    currentView.sunriselabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.sunriselabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        //BOOL isAM = [timeTable.zohar integerValue] < 12 && [timeTable.zohar integerValue] > 7; //Vimal testing
        BOOL isAM = [timeTable.zohar integerValue] > 9.00 && [timeTable.zohar integerValue] < 11.59;
        
        
        //        if ([timeTable.zohar integerValue] > 9.00 && [timeTable.zohar integerValue] < 11.59) {
        //            NSLog(@"TRUE");
        //        }
        ...
        //12/12/2017
        /*int timeFormat;
        if (isTimeFormat24 == true) {
            timeFormat = 12;
        }*///Vimal
        /*else if (isTimeFormat24 == false) {
         timeFormat = 12;
         }*/
        [self compairCurrentTimeWithTime:timeTable.zohar isAMformat:isAM withTimeFormat:12];//currentTimeFormat.format
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.zoharLabel.text = currentView.zoharLabel.text;
                /*if (pageNumber == 0) {
                    currentView.zoharLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.zoharLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        /*if ([timeTable.zoharj integerValue] < 12.00 && [timeTable.zoharj integerValue] < 7.00){
         NSLog(@"False");
         isPM = false;
         }*/
        ...
        if ([timeTable.zoharj integerValue] < 11.59 && [timeTable.zoharj integerValue] < 7.00){
            //NSLog(@"True");
            
            isPM = false;
        }
        
        [self compairCurrentTimeWithTime:timeTable.zoharj isAMformat:isPM withTimeFormat:currentTimeFormat.format];//currentTimeFormat.format //24 vimal testing //isAMformat:NO
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.zoharTitleLabel.textColor = [UIColor greenColor];
                currentView.zoharJlabel.text = currentView.zoharJlabel.text;
                /*if (pageNumber == 0) {
                    //currentView.zoharJlabel.textColor = [UIColor redColor];
                    currentView.zoharJlabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.zoharJlabel.backgroundColor = [UIColor orangeColor];
                }*/
               ...
               /* if (pageNumber == 0) {
                ...
                /*currentView.zoharJlabel.textColor = [UIColor purpleColor];
                //currentView.zoharJlabel.backgroundColor = [UIColor orangeColor];
                //currentView.zoharJlabel.font = [UIFont fontWithName:@"Arial" size:20];
                [currentView.zoharJlabel setFont:[UIFont systemFontOfSize:12]];*/
            }
        }
        else {
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.asarlabel.text = currentView.asarlabel.text;
                
                /*if (pageNumber == 0) {
                    currentView.asarlabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.asarlabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.asarTitlelabel.textColor = [UIColor greenColor];
                currentView.asarJLabel.text = currentView.asarJLabel.text;
                
                /*if (pageNumber == 0) {
                    currentView.asarJLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.asarJLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.maghribLabel.text = currentView.maghribLabel.text;
                
                /*if (pageNumber == 0) {
                    currentView.maghribLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.maghribLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart){
            if ([frstPrayerText length] == 0) {
                ...
                currentView.maghribTitleLabel.textColor = [UIColor greenColor];
                currentView.maghribJLabel.text = currentView.maghribJLabel.text;
                /*if (pageNumber == 0) {
                    currentView.maghribJLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.maghribJLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.eshaLabel.text = currentView.eshaLabel.text;
                /*if (pageNumber == 0) {
                    currentView.eshaLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.eshaLabel.backgroundColor = [UIColor orangeColor];
                }*/
        ...
        if (isEventNotStart) {
            if ([frstPrayerText length] == 0) {
                ...
                currentView.eshaJLabel.text = currentView.eshaLabel.text;
                /*if (pageNumber == 0) {
                    currentView.eshaJLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
                    currentView.eshaJLabel.backgroundColor = [UIColor orangeColor];
                }*/
                ...
                currentView.eshaJLabel.text = currentView.eshaJLabel.text;
                /*if (pageNumber == 0) {
                    currentView.eshaJLabel.backgroundColor = [UIColor orangeColor];
                }
                else if(pageNumber == 1 || pageNumber == 2){
...
- (void)compairCurrentTimeWithTime:(NSString*)eventStart isAMformat:(BOOL)formatAM withTimeFormat:(int)format
{
    ...
    if (format == 12) {
        ...
        NSLog(@"%f",[[eventStart stringByReplacingOccurrencesOfString:@":" withString:@"."] floatValue]);
        NSLog(@"%f",[[dateString stringByReplacingOccurrencesOfString:@":" withString:@"."] floatValue]);
        
        
        /*NSDateFormatter *dateFormatter1 = [[NSDateFormatter alloc] init];
        dateFormatter1.dateFormat = @"HH:mm";
        NSString *pmamDateString1 = [dateFormatter1 stringFromDate:evenStartDate];
        
        NSLog(@"%@",pmamDateString1);
        
        
        /////
        NSDateFormatter *dateFormatter2 = [[NSDateFormatter alloc] init];
        dateFormatter2.dateFormat = @"HH:mm";
        NSString *pmamDateString2 = [dateFormatter2 stringFromDate:[NSDate date]];
        
        NSLog(@"%@",pmamDateString2);
    ...
    if (timeTable) {
        ...
        if ([userDefault valueForKey:@"format12"]) {
            if (isTimeFormat24) {
                ...
                NSDate* zoharDate ;
                // vimal testing
                if ([timeTable.zohar integerValue] > 9.00 && [timeTable.zohar integerValue] <11.59) { //vimal testing
                ...
                /*if ([timeTable.zohar integerValue] < 12 && ([timeTable.zohar integerValue] > 1 && [timeTable.zohar integerValue] < 7)) { //vimal testing
                 zoharDate = [df dateFromString:[NSString stringWithFormat:@"%@%@", timeTable.zohar, stringAM]];
                 } else {
                 zoharDate = [df dateFromString:[NSString stringWithFormat:@"%@%@", timeTable.zohar, stringPM]];
                 }*/
                ...
                NSDate* zoharjDate;
                if ([timeTable.zoharj integerValue] > 9.00 && [timeTable.zoharj integerValue] <11.59) { //vimal testing
                    zoharjDate = [df dateFromString:[NSString stringWithFormat:@"%@%@", timeTable.zoharj, stringAM]];
                } else {
                    zoharjDate = [df dateFromString:[NSString stringWithFormat:@"%@%@", timeTable.zoharj, stringPM]];
                }
...
- (void)updateLocalNotifications
{
    ...
    if (IS_IOS_10_OR_LATER) {
        ...
        // Comment Depreciate code
        //[[UIApplication sharedApplication] cancelAllLocalNotifications];
        
        // New Code For Depreciate
        /*UNUserNotificationCenter *center = [UNUserNotificationCenter currentNotificationCenter];
...
//            timeFormat = 12;
//        }*/
//        [self compairCurrentTimeWithTime:timeTable.zohar isAMformat:isAM withTimeFormat:timeFormat];//currentTimeFormat.format
//        
//        if (isEventNotStart) {
//            if ([frstPrayerText length] == 0) {
//                frstPrayerText = @"Zohar begins in";
...
//            isPM = false;
//        }
////        [self compairCurrentTimeWithTime:timeTable.zoharj isAMformat:isPM withTimeFormat:currentTimeFormat.format];//currentTimeFormat.format //24 vimal testing //isAMformat:NO Vimal Original
//        timeFormat = 24;
//        [self compairCurrentTimeWithTime:timeTable.zoharj isAMformat:isPM withTimeFormat:timeFormat];//currentTimeFormat.format //24 vimal testing //isAMformat:NO
//        //NSLog(@"%@", isEventNotStart);
//        if (isEventNotStart == nil) {
//            isEventNotStart = true;
//        }
//        if (isEventNotStart) {
//            if ([frstPrayerText length] == 0) {
//                frstPrayerText = @"Zohar Jamaat in";
